...
\begin{itemize}
	...
	\item For evaluating the captions, we calculate the BLEU \cite{bleu} scores across 4 thresholds at $\left \{1, 2, 3, 4\right\}$, METEOR \cite{meteor} and CIDEr \cite{cider}, based on the official ActivityNet challenge guidelines.
\end{itemize}
...
\begin{table}[]
	\begin{tabular}{|c|cclllcc|}
		...
		& \multicolumn{1}{c|}{METEOR}             & \multicolumn{1}{c|}{CIDEr}              & \multicolumn{1}{c|}{ROUGE-L}               & \multicolumn{1}{l|}{B@1}             & \multicolumn{1}{l|}{B@2}           & \multicolumn{1}{c|}{B@3}           & B@4                                \\ \hline
		...
		\textbf{Our model}                     & \multicolumn{1}{c|}{\textbf{6.77}} & \multicolumn{1}{l|}{\textbf{32.67}} & \multicolumn{1}{l|}{\textbf{14.986}} & \multicolumn{1}{l|}{\textbf{15.812}} & \multicolumn{1}{l|}{\textbf{6.34}} & \multicolumn{1}{l|}{\textbf{2.28}} & \multicolumn{1}{l|}{\textbf{0.87}} \\ \hline
	\end{tabular}
...
\begin{table}[]
	\begin{tabular}{|c|ccc|}
		...
		Iashin \textit{et al} \cite{iashin2020better} BMT                             & \multicolumn{1}{c|}{48.23}          & \multicolumn{1}{c|}{80.31}          & 60.27          \\ \hline
		...
		\textbf{Our model}              & \multicolumn{1}{c|}{\textbf{67.21}} & \multicolumn{1}{c|}{\textbf{66.86}} & \textbf{67.03} \\ \hline
	\end{tabular}
